...
manifest={'source_pdf':'/home/rclab/Downloads/fig3_combined (1).pdf',
 'size_inches':[3.5,7.2],'snapshot_times_s':TIMES,'snapshot_crop_xyxy':[420,270,870,720],
...
for i,(method,title,color) in enumerate(zip(('hybrid','mlp_only'),('(a) LocoDyad','(b) MLP-E2E (Aux)'),COLORS)):
 ...
 contact=fig.add_axes([.20,.535-offset,.775,.065])
...
print('Saved 3.5 x 7.2 inch figure with original 700-sample traces and 8 snapshots.')
