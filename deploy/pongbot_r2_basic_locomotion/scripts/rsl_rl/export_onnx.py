...
@update 2026-07-29: Keep only the OnPolicyRunner used by the basic Flat/Rough source distribution.
"""
...
def main():
    ...
    runner_classes = {"OnPolicyRunner": OnPolicyRunner}
    ...
    runner = runner_classes[runner_type](
